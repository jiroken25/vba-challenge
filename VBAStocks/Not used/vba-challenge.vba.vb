...
searchkey = Cells(i, 9).Value

j = 2
Do While j < lastrowdata

If Cells(j, 1) = searchkey And Cells(j, 2) = fisrtdate Then
firstvalue = Cells(j, 3).Value
Else
End If

If Cells(j, 1) = searchkey And Cells(j, 2) = lastdate Then
lastvalue = Cells(j, 6).Value
Else
End If
